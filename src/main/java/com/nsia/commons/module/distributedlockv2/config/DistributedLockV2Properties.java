package com.nsia.commons.module.distributedlockv2.config;
 ...
 */
@Getter @Setter
@ConfigurationProperties(prefix = "distributed-lock-v2")
@Configuration
public class DistributedLockV2Properties
{
    private Map<String, DistributedLockV2Config> mapOfDistributedLockV2Config;

    @Getter @Setter @NoArgsConstructor @AllArgsConstructor
    public static class DistributedLockV2Config
    {
        private boolean primaryBean = false;
         ...
         * <br/>
         * The pub-sub is the preferred mode due to less network chatter between client Redis server, and more performant - the lock is acquired immediately when subscription is notified about unlocking in the other process.
        ...
        /*
         * If the lock is not unlocked until releaseTimeDuration reached, then this exception below will be thrown:
