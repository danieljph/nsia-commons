package com.nsia.commons.module.httpclient.restclientfactory.controller;

import com.nsia.commons.module.httpclient.restclientfactory.RestClientFactory;
...
@RestController
@RequestMapping("/rest-client-factory-test")
public class RestClientFactoryTestController
{
    ...
    {
        var api2Uri = "http://localhost:8080/nsia-commons/rest-client-factory-test/api2";
        ...
        var responseApi2 = restClientFactory.postForEntity(api2Uri, api2RequestHttpEntity, Api2Response.class);
